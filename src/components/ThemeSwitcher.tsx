...
import { useTheme, ThemeName } from '@/common/ThemeContext';
          ...
          <div className="p-2">
            ...
            {themes.map((t) => (
              <button
                ...
                className={`w-full px-2 py-2 text-left text-sm hover:bg-gray-100 transition-colors flex items-center justify-between ${
